...
export default function MapLegend(props: LegendProps): JSX.Element {
    ...
    return (
        <Svg {...props}>
            ...
            <LegendElement X={10} Y={10} color={"#CF2030"} text='Concessions' />
            <LegendElement X={10} Y={45} color={"#5080C9"} text='Restrooms' />
            <LegendElement X={10} Y={80} color={"#FFFF00"} text='Merchandise' />
            <LegendElement X={10} Y={115} color={"#84CE0A"} text='Fan Services' />
            ...
            <LegendElement X={10} Y={150} color={"#0000FF"} text="Batter's Box" />
